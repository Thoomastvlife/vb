Public Class Form1
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Dim m0, m1, m2, m3, m4
        FileOpen(1, "c:\test\1060301.t02", OpenMode.Input)
        Input(1, m0)
        FileClose(1)
        Do While True
            m2 = m1 \ 10
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Dim m0, m1, m2, m3, m4
        FileOpen(1, "c:\test\1060302.t02", OpenMode.Input)
        Input(1, m0)
        FileClose(1)
        Dim i = 1
        Do While i <= m0
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Dim m0, m1, m2, m3, m4
        FileOpen(1, "c:\test\1060303.t02", OpenMode.Input)
        Input(1, m0)
        FileClose(1)
        Dim i = 1
        Do While i <= m0
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        FileOpen(1, "c:\test\1060304.t02", OpenMode.Input)
        Dim i = 1
        Do While i <= 3
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        FileOpen(1, "c:\test\1060305.t02", OpenMode.Input)
